  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: `Standard delivery is free on orders above ${formatPrice(commerce.freeShippingThreshold)}. Below that it's ${formatPrice(commerce.shippingFlatRate)}. Express is always ${formatPrice(commerce.expressShippingRate)}.`,
      },
      {
    ...
    items: [
      {
        ...
        a: `UPI, credit and debit cards, and cash on delivery (₹${commerce.codFee} handling fee).`,
      },
      {
